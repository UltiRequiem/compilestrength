...
**📚 [ONBOARDING.md](docs/ONBOARDING.md)** - Complete setup and architecture
guide for new developers

This guide covers development environment setup, project architecture, common
tasks, and troubleshooting tips.
