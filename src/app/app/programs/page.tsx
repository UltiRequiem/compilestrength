				...
				<div className="text-center space-y-6 max-w-md">
					...
					<div className="space-y-2">
						...
						<p className="text-muted-foreground text-sm">
							You haven't created any workout programs yet. Use the AI Compiler
							to generate your first program.
						</p>
					</div>
					<Button
						onClick={() => {
														...
														>
															<div className="flex-1">
																...
																<div className="text-xs text-muted-foreground mt-1">
																	{routine.goals.join(", ")} •{" "}
																	{routine.frequency}x/week • {routine.duration}{" "}
																	weeks • {routine.days.length} days
																</div>
															</div>
				...
				<Card className="mt-8 border-primary/50">
					...
					<CardContent>
						<div className="space-y-4 terminal-text text-sm text-primary">
							...
							<p>
								<span className="text-muted-foreground">{">"}</span> Difficulty
								Level: {selectedRoutine.difficulty} - suitable for lifters with
