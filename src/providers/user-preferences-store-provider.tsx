...
import { type ReactNode, createContext, useRef, useContext, useEffect, useState, useMemo } from 'react'
...
export type UserPreferencesStoreApi = ReturnType<typeof createUserPreferencesStore>

export const UserPreferencesStoreContext = createContext<UserPreferencesStoreApi | undefined>(
  undefined,
)
...
export const UserPreferencesStoreProvider = ({
  ...
  useEffect(() => {
    const loadPreferences = async () => {
      if (session?.user && storeRef.current && !storeRef.current.getState().hasLoadedFromServer) {
...
const restTimerSelector = (state: UserPreferencesStore) => state.restTimerDefault
const trainingGoalSelector = (state: UserPreferencesStore) => state.trainingGoal
const experienceLevelSelector = (state: UserPreferencesStore) => state.experienceLevel

// Convenience hooks for common use cases
export const useUnits = () => useUserPreferencesStore(unitsSelector)
export const useRestTimerDefault = () => useUserPreferencesStore(restTimerSelector)
export const useTrainingGoal = () => useUserPreferencesStore(trainingGoalSelector)
export const useExperienceLevel = () => useUserPreferencesStore(experienceLevelSelector)

// Individual action selectors to prevent object recreation
const setUnitsSelector = (state: UserPreferencesStore) => state.setUnits
const setRestTimerDefaultSelector = (state: UserPreferencesStore) => state.setRestTimerDefault
const setTrainingGoalSelector = (state: UserPreferencesStore) => state.setTrainingGoal
const setExperienceLevelSelector = (state: UserPreferencesStore) => state.setExperienceLevel
const setAvailableDaysSelector = (state: UserPreferencesStore) => state.setAvailableDays
const setPreferencesSelector = (state: UserPreferencesStore) => state.setPreferences
const resetPreferencesSelector = (state: UserPreferencesStore) => state.resetPreferences

// Individual action hooks
export const useSetUnits = () => useUserPreferencesStore(setUnitsSelector)
export const useSetRestTimerDefault = () => useUserPreferencesStore(setRestTimerDefaultSelector)
export const useSetTrainingGoal = () => useUserPreferencesStore(setTrainingGoalSelector)
export const useSetExperienceLevel = () => useUserPreferencesStore(setExperienceLevelSelector)
export const useSetAvailableDays = () => useUserPreferencesStore(setAvailableDaysSelector)
export const useSetPreferences = () => useUserPreferencesStore(setPreferencesSelector)
export const useResetPreferences = () => useUserPreferencesStore(resetPreferencesSelector)
