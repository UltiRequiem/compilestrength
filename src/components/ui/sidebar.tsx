...
>(({ className, ...props }, ref) => {
	...
	return (
		<button
			...
			className={cn(
				"absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] transition-all ease-linear after:transition-all after:duration-200 sm:flex",
				"hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 group-data-[side=right]:rotate-180",
